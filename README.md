...
app/
  ...
  assets/pathmark.png
downloads/
  Pathmark_Local_App_Windows_v0_5_54.zip
latest_version.json
requirements.txt
...
This release fixes the hosted Streamlit dependency error by adding PyYAML and aligning the public release hub requirements with the local app requirements.
